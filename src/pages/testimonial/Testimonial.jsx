    ...
    <div>
     <section className="text-gray-600 body-font mb-10">
                <div className="container px-5 py-10 mx-auto">
                    <h1 className=' text-center text-4xl mb-10  font-body  font-bold text-gray-700' >The Stunning Results our <br></br>
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  className="leading-relaxed  font-body ">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                                <span className="inline-block h-1 w-10 rounded bg-blue-800 mt-6 mb-4" />
                                <h2  className="text-gray-900  font-body  font-medium title-font tracking-wider text-sm uppercase">Andrew Matthew</h2>
                                <p className="text-gray-500  font-body ">Senior Product Designer</p>
                            </div>
                        </div>
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  className="leading-relaxed  font-body ">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                                <span className="inline-block h-1 w-10 rounded bg-blue-800 mt-6 mb-4" />
                                <h2  className="text-gray-900  font-body  font-medium title-font tracking-wider text-sm uppercase">Lisa Madona</h2>
                                <p  className="text-gray-500  font-body ">UI Develeoper</p>
                            </div>
                        </div>
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  className="leading-relaxed  font-body ">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                                <span className="inline-block h-1 w-10 rounded bg-blue-800 mt-6 mb-4" />
                                <h2  className="text-gray-900  font-body  font-medium title-font tracking-wider text-sm uppercase">Arundhati Joshi</h2>
                                <p  className="text-gray-500  font-body ">CTO</p>
                            </div>
                        </div>
                    </div>
                </div>
